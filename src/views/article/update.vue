         ...
         <el-row style="padding-left:20px;padding-right:120px;">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                ...
                <el-form-item label="文章分类">
                    <category-select v-model="form.category.id"></category-select>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button type="primary" @click="saveContent('form')">修改文章</el-button>
            ...
            saveContent(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        http.put(api.getArticleDetail(this.id), this.form).then(res => {
                            this.$message({
                                message: '文档修改成功',
                                type: 'success'
                            })
